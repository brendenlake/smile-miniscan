...
<template>
  <!-- Unpaid/credit study consent (e.g., SONA) -->
  <div v-if="api.getConfig('unpaidStudy')" class="p-3 pt-2 text-left">
    ...
    <ul class="pl-8 pt-3 pb-3 list-square">
      <li>
        Participation in this study will take about 30 minutes to complete. You will receive course credit for your
        participation.
      </li>
  ...
  <!-- Paid study consent (default) -->
  <div v-else class="p-3 pt-2 text-left">
    <h1 class="text-3xl font-bold"><i-mdi-approve class="inline-block mr-2" />Informed Consent</h1>
    <hr class="mt-2 mb-3 h-px" />
    <p>
      If you agree to be in this study, you will be asked to look at pictures of objects or pictures presented on a
